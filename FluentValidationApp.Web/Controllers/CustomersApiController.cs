...
namespace FluentValidationApp.Web.Controllers
{
    ...
    public class CustomersApiController : ControllerBase
    {
        ...
        {
            Customer customer = new Customer { Id = 1, Name = "Ugur", Email = "ucyoglu@outlook.com", Age = 28,CreditCard=new CreditCard { Number="1234",ValidDate=DateTime.Now} };
        ...
        public async Task<ActionResult<Customer>> PostCustomer(Customer customer)
        {
            ...
            if (!result.IsValid)
            {
                return BadRequest(result.Errors.Select(a => new { property = a.PropertyName, error = a.ErrorMessage }));
            }
